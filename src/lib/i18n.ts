...
const resources = {
  en: {
    translation: {
      ...
      "btn_continue_email": "Continue with Email",
      "login_prompt_message": "Log in to sync your workspace and access premium features across devices.",
      "btn_sending": "Sending...",
  ...
  ko: {
    translation: {
      ...
      "btn_cancel": "취소",
      "btn_continue": "계속하기",
      "btn_continue_email": "이메일로 계속하기",
      "login_prompt_message": "로그인하여 여러 기기에서 워크스페이스를 동기화하고 프리미엄 기능을 사용해보세요.",
      "btn_sending": "전송 중...",
